...
function () {
  function Store() {
    ...
    this._vlowGetActions().forEach(function (a) {
  ...
  (0, _createClass2.default)(Store, [{
    key: "_vlowGetActions",
    value: function _vlowGetActions() {
    ...
    value: function _vlowRemoveListener(id) {
      ...
      var isNonPersistent = this.isNonPersistent !== undefined ? this.isNonPersistent : this.constructor.isNonPersistent;
      isNonPersistent === true && Object.keys(this._vlowListeners_).length === 0 && this._vlowDropStore();
    }
  }, {
    key: "_vlowDropStore",
    value: function _vlowDropStore() {
      var _this3 = this;

      this._vlowGetActions().forEach(function (a) {
        return a._dropStore(_this3);
      });

      Store._vlowRemoveStore(this.constructor);
    }
  }], [{
    key: "_vlowRemoveStore",
    value: function _vlowRemoveStore(StoreClass) {
      var idx = _stores.findIndex(function (m) {
